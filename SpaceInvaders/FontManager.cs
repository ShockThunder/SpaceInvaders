    ...
    public class FontManager
    {
        ...
        public void DrawTitleScreen()
        {
            ...
            _spriteBatch.DrawString(_gameFont, title, new Vector2((_screenWidth - titleSize.X * scale) / 2, (_screenHeight - titleSize.Y * scale) / 2),
                Color.White, 0.0f, default, scale, SpriteEffects.None, 0);

            _spriteBatch.DrawString(_gameFont, startMsg, new Vector2((_screenWidth - startMsgSize.X) / 2, (_screenHeight + titleSize.Y * scale + startMsgSize.Y * 4) / 2),
                Color.White, 0.0f, default, 1.0f, SpriteEffects.None, 0);

            _spriteBatch.Draw(_gameContent.imgTitle, new Vector2((_screenWidth - (_gameContent.imgTitle.Width / 5)) / 2, 50), null,
        ...
        public void DrawEndScreen()
        {
            ...
            _spriteBatch.DrawString(_gameFont, endMsg, new Vector2((_screenWidth - startMsgSize.X) / 2, (_screenHeight + titleSize.Y * scale + startMsgSize.Y * 4) / 2),
                Color.White, 0.0f, default, 1.0f, SpriteEffects.None, 0);
